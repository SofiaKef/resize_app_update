...
import ViewDocumentUseQuery from '../../pages/ViewDocumentUseQuery';
import DocumentsUseQueryUseMutation from '../../pages/DocumentsUseQueryUseMutation';
        ...
        <Grid>
          <Switch>
            ...
            <Authenticated
              ...
              {...state}
            />
            <Route exact path="/documents/:_id" component={ViewDocumentUseQuery} />
            <Authenticated
              exact
